...
public class PainterController {
    ...
    // Method to open the color chooser and get the color
    @FXML
    private void openColorChooser(ActionEvent event) {
        try {
            ...
            ColorChooserController colorChooserController = loader.getController();
    ...
    // Add a method in the PainterController to set the brushColor
