...
public class PhoneNumberWordGenerator {
    ...
    public static void generateWords(String phoneNumber) {
        try (Formatter output = new Formatter(new FileOutputStream("phone_words.txt"))) {
    ...
    public static void main(String[] args) {
        String phoneNumber = "6392277"; // Replace this with the desired phone number
        generateWords(phoneNumber);
        System.out.println("Words generated and saved to 'phone_words.txt'.");
    }
}
